...
import com.innext.xjx.bean.AppInfo;
import com.innext.xjx.bean.UserSmsInfoBean;
...
import com.innext.xjx.util.ServiceUtil;
...
public class EventController implements UploadContentsContract.View {
    ...
    private void saveUserInfo(UserInfoBean userInfo, Context context) {
        if (userInfo != null) {
            ...
            //判断service是否开启
            if (!ServiceUtil.isServiceRunning(context, "com.innext.xjx.ui.my.service.UploadPOIService")) {
