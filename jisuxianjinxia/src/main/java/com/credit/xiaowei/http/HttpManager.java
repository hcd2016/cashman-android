...
public class HttpManager {
    ...
    public static String getUrl(String url) {
        ...
        if(url.contains("clientType=android&appVersion=")){
            ...
            Log.e("这里是日志","URL的数据"+(App.getConfig().getLoginStatus()?SpUtil.getString(Constant.SHARE_TAG_USERNAME):""));
            if (url.contains("?")) {
                ret_url = url + "&";
            } else {
                ret_url = url + "?";
            ...
            ret_url += "clientType=android&appVersion="
                    ...
                    (App.getConfig().getLoginStatus()?SpUtil.getString(Constant.SHARE_TAG_USERNAME):"")
