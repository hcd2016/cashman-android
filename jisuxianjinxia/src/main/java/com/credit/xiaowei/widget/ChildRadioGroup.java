...
/**
 * 使radioGroup支持radioButton在子View里面任然可以单选
 */

public class ChildRadioGroup extends LinearLayout {
    private static final String TAG = ChildRadioGroup.class.getSimpleName();
     ...
     * {@inheritDoc}
     */
    public ChildRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    /**
     * <p>RegisterBean a callback to be invoked when the checked radio button
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new ChildRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof ChildRadioGroup.LayoutParams;
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(ChildRadioGroup.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(ChildRadioGroup.class.getName());
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(ChildRadioGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void setIdAndOnCheckedChangeListener(RadioButton rb){
            ...
            if (checkedCount > 1) {
                ChildRadioGroup.this.removeAllViews();
            }
        ...
        public void onChildViewAdded(View parent, View child) {
            ...
            if (parent == ChildRadioGroup.this && child instanceof RadioButton) {

                setIdAndOnCheckedChangeListener((RadioButton) child);

            } else if (parent == ChildRadioGroup.this && child instanceof ViewGroup) {
